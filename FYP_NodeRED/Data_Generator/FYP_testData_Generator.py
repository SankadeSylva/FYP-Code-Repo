...
txt_digits = ["01", "02", "03", "04", "05", "06", "07", "08", "09"]
days = txt_digits
...
f_path = "/home/pi/FYP-Code-Repo/FYP_NodeRED/Data_Generator/"
...
while 1:
    ...
    print("COMPLETED YEAR: " + str(n_year))
print("Program Ended")
